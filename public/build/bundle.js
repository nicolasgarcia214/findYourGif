...
var app = (function () {
    ...
    */
    ...
    /* src\Pages\components\Chart.svelte generated by Svelte v3.21.0 */
    const file = "src\\Pages\\components\\Chart.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas, "width", "4");
    			attr_dev(canvas, "height", "1");
    			add_location(canvas, file, 63, 2, 1444);
    			attr_dev(div, "class", "Chart svelte-1loljm0");
    			add_location(div, file, 62, 0, 1421);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_store(numberOfGifs, "numberOfGifs");
    	component_subscribe($$self, numberOfGifs, $$value => $$invalidate(3, $numberOfGifs = $$value));
    	let ctx;
    	let myChart;
    ...
    /* src\Pages\components\Button.svelte generated by Svelte v3.21.0 */
    const file$1 = "src\\Pages\\components\\Button.svelte";
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => dispatch("active");
    ...
    /* src\Pages\components\Loader.svelte generated by Svelte v3.21.0 */

    const file$2 = "src\\Pages\\components\\Loader.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(animate0, file$2, 25, 6, 521);
    			...
    			add_location(animate1, file$2, 32, 6, 729);
    			attr_dev(rect0, "y", "10");
    			attr_dev(rect0, "width", "15");
    			attr_dev(rect0, "height", "120");
    			attr_dev(rect0, "rx", "6");
    			add_location(rect0, file$2, 24, 4, 469);
    			...
    			add_location(animate2, file$2, 41, 6, 996);
    			...
    			add_location(animate3, file$2, 48, 6, 1205);
    			attr_dev(rect1, "x", "30");
    			attr_dev(rect1, "y", "10");
    			attr_dev(rect1, "width", "15");
    			attr_dev(rect1, "height", "120");
    			attr_dev(rect1, "rx", "6");
    			add_location(rect1, file$2, 40, 4, 937);
    			...
    			add_location(animate4, file$2, 57, 6, 1466);
    			...
    			add_location(animate5, file$2, 64, 6, 1672);
    			attr_dev(rect2, "x", "60");
    			attr_dev(rect2, "width", "15");
    			attr_dev(rect2, "height", "140");
    			attr_dev(rect2, "rx", "6");
    			add_location(rect2, file$2, 56, 4, 1414);
    			...
    			add_location(animate6, file$2, 73, 6, 1937);
    			...
    			add_location(animate7, file$2, 80, 6, 2146);
    			attr_dev(rect3, "x", "90");
    			attr_dev(rect3, "y", "10");
    			attr_dev(rect3, "width", "15");
    			attr_dev(rect3, "height", "120");
    			attr_dev(rect3, "rx", "6");
    			add_location(rect3, file$2, 72, 4, 1878);
    			...
    			add_location(animate8, file$2, 89, 6, 2415);
    			...
    			add_location(animate9, file$2, 96, 6, 2623);
    			attr_dev(rect4, "x", "120");
    			attr_dev(rect4, "y", "10");
    			attr_dev(rect4, "width", "15");
    			attr_dev(rect4, "height", "120");
    			attr_dev(rect4, "rx", "6");
    			add_location(rect4, file$2, 88, 4, 2355);
    			attr_dev(svg, "width", /*width*/ ctx[0]);
    			attr_dev(svg, "height", /*height*/ ctx[1]);
    			attr_dev(svg, "fill", /*color*/ ctx[2]);
    			attr_dev(svg, "viewBox", "0 0 135 140");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "aria-label", /*label*/ ctx[3]);
    			add_location(svg, file$2, 17, 2, 322);
    			attr_dev(div, "class", "Loader-container svelte-12bebvo");
    			add_location(div, file$2, 16, 0, 288);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ width, height, color, label });
    	...
    	return [width, height, color, label];
    }

    class Loader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { width: 0, height: 1, color: 2, label: 3 });
    ...
    /* src\Pages\components\Search.svelte generated by Svelte v3.21.0 */

    const { Object: Object_1 } = globals;
    const file$3 = "src\\Pages\\components\\Search.svelte";
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div4_transition) div4_transition = create_bidirectional_transition(div4, fly, { y: 200, duration: 2000 }, true);
    		...
    		o: function outro(local) {
    			if (!div4_transition) div4_transition = create_bidirectional_transition(div4, fly, { y: 200, duration: 2000 }, false);
    ...
    function create_if_block(ctx) {
    	...
    	let div_class_value;
    	let current;
    	let if_block = /*count*/ ctx[1] >= 24 && create_if_block_1(ctx);
    	const button = new Button({ props: { label: "NEXT" }, $$inline: true });
    	button.$on("active", /*fetchGifsNextButton*/ ctx[5]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*count*/ 2 && div_class_value !== (div_class_value = "" + (null_to_empty(/*count*/ ctx[1] >= 24 ? "Buttons" : "Button") + " svelte-cdzsc9"))) {
    ...
    function create_if_block_1(ctx) {
    	...
    	button.$on("active", /*getGifsBackButton*/ ctx[6]);
    ...
    function create_fragment$3(ctx) {
    	...
    	let if_block1 = /*count*/ ctx[1] >= 12 && create_if_block(ctx);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $names;
    	let $numberOfGifs;
    	validate_store(gifs, "gifs");
    	component_subscribe($$self, gifs, $$value => $$invalidate(3, $gifs = $$value));
    	validate_store(names, "names");
    	component_subscribe($$self, names, $$value => $$invalidate(9, $names = $$value));
    	validate_store(numberOfGifs, "numberOfGifs");
    	component_subscribe($$self, numberOfGifs, $$value => $$invalidate(10, $numberOfGifs = $$value));
    	let visible = false;
    	...
    	async function fetchGifsSearch() {
    		...
    		if (Object.keys(totalGifs).includes(search)) {
    			...
    			if (!$names.includes(search)) {
    				set_store_value(names, $names = [...$names, search]);
    				set_store_value(numberOfGifs, $numberOfGifs = [...$numberOfGifs, json.pagination.total_count]);
    			}
    		}
    	...
    	function getGifsBackButton() {
    		...
    		if (count === 0) {
    			...
    			set_store_value(gifs, $gifs = totalGifs[search].slice(count - 24, count - 12));
    			$$invalidate(1, count -= 12);
    		}
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("previousSearch" in $$props) previousSearch = $$props.previousSearch;
    		if ("totalGifs" in $$props) totalGifs = $$props.totalGifs;
    	};
    ...
    /* src\Pages\Main.svelte generated by Svelte v3.21.0 */
    const file$4 = "src\\Pages\\Main.svelte";

    // (9:2) {#if $numberOfGifs.length > 2}
    function create_if_block$1(ctx) {
    	let div;
    	let div_transition;
    	let current;
    	const chart = new Chart_1({ $$inline: true });

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(chart.$$.fragment);
    			add_location(div, file$4, 9, 4, 288);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(9:2) {#if $numberOfGifs.length > 2}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let t;
    	let current;
    	let if_block = /*$numberOfGifs*/ ctx[0].length > 2 && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 7, 0, 230);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (/*$numberOfGifs*/ ctx[0].length > 2) {
    				if (if_block) {
    					if (dirty & /*$numberOfGifs*/ 1) {
    						transition_in(if_block, 1);
    					}
    				} else {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let $numberOfGifs;
    	validate_store(numberOfGifs, "numberOfGifs");
    	component_subscribe($$self, numberOfGifs, $$value => $$invalidate(0, $numberOfGifs = $$value));
    	const writable_props = [];
